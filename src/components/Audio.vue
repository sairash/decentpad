...
<template>
    <div class="fixed pl-10 py-5 pr-5 right-0 bottom-0" v-on:mouseleave="option_visible = false">
        <div class="mb-4 flex flex-col gap-3" v-if="option_visible">
            <button 
                class="cursor-pointer opacity-60 hover:opacity-100 rounded-full p-4.5 transition-colors" 
        ...
        <button
            class="p-4 hover:bg-zinc-600 bg-zinc-700 rounded-full cursor-pointer text-white transition-colors"
